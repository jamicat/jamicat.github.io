...
strings: [
'<span class="text-white text-lg mr-2 text-pink-glow">I´ll figure out a way to get us out of here</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">ฅ(^ω^ฅ)</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">(ฅ^ω^)ฅ</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">ฅ(^ω^)ฅ</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">(๑•ω•́ฅ✧</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">(ฅ`･ω･´)っ=</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">ฅ*•ω•*ฅ</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">ฅ^•ﻌ•^ฅ</span>',
'<span class="text-white text-lg mr-2 text-pink-glow">⊱ฅ•ω•ฅ⊰</span>'
],
typeSpeed: 60,
backSpeed: 30,
...
controls: 0,
loop: 1,
playlist: 'ZM_Gamwxvtc,9DiJJVfZXUk',
playsinline: 1,
modestbranding: 1,
rel: 0,
fs: 0,
...
function showGuestBook() {
  ...
  <div class="drag-area text-pink-300 text-sm mb-2 select-none flex justify-between items-center">
    <span class="flex items-center space-x-2">
      <img src="art1.jpg" alt="Avatar2" class="avatar-icon" />

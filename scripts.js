...
`;
 ...
 <span id="typed2" class="font-['Fink'] font-medium text-2xl mt-10 mb-4 text-blue-glow no-theme-glow"> guest wall!
 </span> 
 </span> 
 ...
 <p id="welcomeMessage" class="text-base italic text-blue-100 font-['nintendoh'] text-sm"> leave a message! </p> </div> 

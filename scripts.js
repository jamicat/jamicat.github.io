const themes = {
  ...
  Cat: {
    ...
    buttonColor: 'bg-transparent hover:bg-transparent',
    buttonTextColor: 'text-white text-blue-glow',
    iconColor: 'text-rose-100 hover:text-rose-100',
    hoverRing: 'hover:ring-teal-400',
    galaxyActive: 'text-rose-100',
    galaxyInactive: 'text-rose-100',
    playActive: 'text-rose-100',
    playInactive: 'text-rose-100',
...
$('#terminalContent').html(`
      ...
      <li class="text-blue-glow text-white theme-body text-xs">jquery, typed.js, interact.js, tailwind css, youtube iframe api, lightgallery, three.js, cloudflare workers & apis, websockets (live guest wall updates), sqlite db, custom guest wall api, custom playlist api, local storage (theme persistence)</li>
      </ul>
      </div>

...
`;
 ...
 <img src="pbcat.gif" alt="Avatar2" class="avatar-icon2" /> 
 ...
 <p id="welcomeMessage" class="text-blue-100 font-['nintendoh'] text-sm"> leave a message! </p> </div>
...
div.innerHTML = `
  <div class="font-['nintendoh'] text-xs mb-1 font-medium text-white text-blue-glow no-theme-glow break-all">
  ...
  <span class="font-['nintendoh'] text-xs text-white text-blue-glow">Jamie</span>
</div>

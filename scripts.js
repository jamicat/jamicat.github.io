const themes = {
  ...
  Cat: {
    ...
    buttonColor: 'bg-transparent hover:bg-transparent',
    buttonTextColor: 'text-white text-blue-glow',
    iconColor: 'text-rose-200 hover:text-rose-200',
    hoverRing: 'hover:ring-teal-400',
    galaxyActive: 'text-rose-200',
    galaxyInactive: 'text-rose-200',
    playActive: 'text-rose-200',
  ...
  Stars: {
   glowPrimary: 'text-pink-glow',     
    ...
    hoverRing: 'hover:ring-cyan-400',
    galaxyActive: 'text-red-400',
    galaxyInactive: 'text-red-300',
    playActive: 'text-red-400',
    playInactive: 'text-red-300',
...
$('#terminalContent').html(`
      ...
      <li id="about" class="text-blue-glow text-white theme-body text-xs">jquery, typed.js, interact.js, tailwind css, youtube iframe api, lightgallery, three.js, cloudflare workers & apis, websockets (live guest wall updates), sqlite db, custom guest wall api, custom playlist api, local storage (theme persistence)</li>
      </ul>
      </div>

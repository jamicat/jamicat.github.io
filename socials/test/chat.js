...
this.discordAuthElement = null;
this.discordAuthButton = null;
this.discordAuthAvatar = null;
this.discordAuthName = null;
this.discordAuthStatus = null;
...
<div
    ...
    class="
        ...
        bg-black/15 px-2.5 py-1.5
    "
>
    <img
        id="chatDiscordAuthAvatar"
        alt=""
        class="
            hidden h-6 w-6 shrink-0 rounded-full
            object-cover
        "
    >
    ...
    <div class="min-w-0 flex-1">
        <div
            id="chatDiscordAuthName"
            class="
                theme-heading truncate
...
this.discordAuthAvatar =
    this.window.querySelector(
        "#chatDiscordAuthAvatar"
    );

this.discordAuthName =
    this.window.querySelector(
        "#chatDiscordAuthName"
    );

this.discordAuthStatus =
    this.window.querySelector(
        "#chatDiscordAuthStatus"
    );
...
setDiscordAuthStatus(
    ...
    if (!this.discordAuthStatus) {
        return;
    }

    this.discordAuthStatus.textContent =
        message;

    this.discordAuthStatus.classList.toggle(
        "text-red-300",
        isError
    );
...
renderDiscordAuthState() {
    ...
    if (this.discordAuthAvatar) {
        this.discordAuthAvatar.classList
            .toggle(
                "hidden",
                !loggedIn
            );

        this.discordAuthAvatar.src =
            loggedIn
                ? this.discordUser.avatarUrl
                : "";
    }

    if (this.discordAuthName) {
        this.discordAuthName.textContent =
            loggedIn
                ? this.discordUser.displayName
                : "discord";
    }
    ...
    this.discordAuthElement?.classList
        .toggle(

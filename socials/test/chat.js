...
onEmojiSelect: emoji => {
            this.handleEmojiPickerSelection(
                emoji
            );
        }
    });
        ...
        for (const emoji of category.emojis) {
            ...
            button.addEventListener(
                ...
                event => {
                    ...
                    this.handleCustomEmojiPickerSelection({
                        id: emoji.id,
                        name:
                            emoji.name ||
                            emoji.id,
...
restoreEmojiPickerHome() {
    ...
    if (
        this.emojiPickerHomeNextSibling &&
        this.emojiPickerHomeNextSibling.parentNode ===
            this.emojiPickerHomeParent
    ) {
        this.emojiPickerHomeParent.insertBefore(
            this.emojiPickerContainer,
            this.emojiPickerHomeNextSibling
        );
    } else {
        this.emojiPickerHomeParent.appendChild(
            this.emojiPickerContainer
        );
    }
}
...
openEmojiPicker({
    ...
    if (this.emojiPickerMode === "reaction") {
        document.body.appendChild(
            this.emojiPickerContainer
        );

        this.emojiPickerContainer.classList.add(
            "jami-emoji-picker-reaction-mode"
        );
    } else {
        this.restoreEmojiPickerHome();

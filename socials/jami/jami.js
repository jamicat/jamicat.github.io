    ...
    class JamiOS {
        ...
        iconSvg(kind, extraClass = "") {
            const icons = {
                ...
                mark: `<svg viewBox="0 0 56 56" aria-hidden="true"><path class="i-shadow" d="M7.5 14.5c0-5.5 4.5-10 10-10h21c5.5 0 10 4.5 10 10v27c0 5.5-4.5 10-10 10h-21c-5.5 0-10-4.5-10-10Z"/><path class="i-main" d="M8.5 14.2c0-4.9 4-8.9 8.9-8.9h21.2c4.9 0 8.9 4 8.9 8.9v26.9c0 4.9-4 8.9-8.9 8.9H17.4c-4.9 0-8.9-4-8.9-8.9Z"/><path class="i-accent" d="M8.5 14.2c0-4.9 4-8.9 8.9-8.9h21.2c4.9 0 8.9 4 8.9 8.9v7.1h-39Z"/><circle class="i-cut" cx="16" cy="13.3" r="1.4"/><circle class="i-cut" cx="20.7" cy="13.3" r="1.4"/><path class="i-ink" d="M18.2 30.1c1.3-.9 2.8-.9 4.1 0m11.4 0c1.3-.9 2.8-.9 4.1 0m-13 5.9c2.1 1.6 4.3 1.6 6.4 0"/><path class="i-highlight" d="M14.4 23.5h27.2"/></svg>`
            };

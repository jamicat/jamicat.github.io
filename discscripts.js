...
statusContainer.className =
  "absolute top-6 left-6 flex items-center space-x-3 p-2.5 rounded-full bg-black/20 backdrop-blur-md border-[1px] border-white/10 text-pink-400 shadow-lg transition-transform duration-300 ease-in-out z-[9999] hover:bg-black/25 hover:border-white/30 font-[Nunito] text-base perspective-[800px]";

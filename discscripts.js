...
statusContainer.innerHTML = `
  ...
  <div id="discordText" class="flex flex-col leading-tight">
    <span id="discordName" style="color:#fca5a5;" class="text-[16px] font-semibold">Loading...</span>
    <span id="discordActivity" style="color:#fca5a5;" class="text-[13.5px] opacity-90 italic">Fetching status...</span>
  </div>
`;
